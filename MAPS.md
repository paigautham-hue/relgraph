...
**Last updated:** 2026-05-08 (Week 2 follow-on — Apify ingestion + dedup + change-detection live; full activation loop end-to-end)
...
| `enrichment` | `0 3 * * 0` (Sun 03:00) | Off | 15 | haiku | ✅ runner, 📋 dispatcher (follow-on) |
